...
{
    /// <summary>
    /// Bitmex Downloader class
    /// </summary>
    public class BitmexDataDownloader : IDataDownloader, IDisposable
    {
        private readonly BitmexBrokerage _brokerage;
        private readonly BitmexSymbolMapper _symbolMapper = new BitmexSymbolMapper();
        private const string _wss = "wss://www.bitmex.com/realtime";
        private const string _rest = "https://www.bitmex.com";

        /// <summary>
        /// Initializes a new instance of the <see cref="BitmexDataDownloader"/> class
        /// </summary>
        public BitmexDataDownloader()
        {
            _brokerage = new BitmexBrokerage(_wss, _rest, null, null, null, null);
        }
        ...
        /// Warning. 
        /// Aggregated data is not used as Volume of aggregated data doesn't match to Bitmex API Response for same period of higher resolution.
        /// </summary>
