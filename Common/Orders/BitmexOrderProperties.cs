...
{
    /// <summary>
    /// Contains additional properties and settings for an order submitted to Bitmex brokerage
    /// </summary>
    public class BitmexOrderProperties : OrderProperties
    {
        /// <summary>
        ...
        {
            return (BitmexOrderProperties)MemberwiseClone();
        }
    }
}
