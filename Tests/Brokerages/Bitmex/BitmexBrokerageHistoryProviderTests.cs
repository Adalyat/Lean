...
{
    [TestFixture]
    public partial class BitmexBrokerageTests
    {
        public TestCaseData[] ValidHistory
        {
            get
            {
                ...
                {
                    // valid 
                    new TestCaseData(Symbol.Create("XBTUSD", SecurityType.Crypto, Market.Bitmex), Resolution.Minute, Time.OneHour, false),
                    new TestCaseData(Symbol.Create("XBTUSD", SecurityType.Crypto, Market.Bitmex), Resolution.Hour, Time.OneDay, false),
                    new TestCaseData(Symbol.Create("XBTUSD", SecurityType.Crypto, Market.Bitmex), Resolution.Daily, TimeSpan.FromDays(15), false),
                };
            }
        }
        ...
        public TestCaseData[] NoHistory
        {
            get
            {
                return new[]
                {
                    new TestCaseData(Symbol.Create("XBTUSD", SecurityType.Crypto, Market.Bitmex), Resolution.Tick, TimeSpan.FromSeconds(15)),
                    new TestCaseData(Symbol.Create("XBTUSD", SecurityType.Crypto, Market.Bitmex), Resolution.Second, Time.OneMinute),
                };
            }
        }
        ...
        public TestCaseData[] InvalidHistory
        {
            get
            {
                return new[]
                {
                    ...
                    new TestCaseData(Symbol.Create("XYZ", SecurityType.Crypto, Market.Bitmex), Resolution.Daily, TimeSpan.FromDays(15), true),
        ...
        public void GetsHistory(Symbol symbol, Resolution resolution, TimeSpan period, bool throwsException)
        {
            TestDelegate test = () =>
            {
                var brokerage = (BitmexBrokerage)Brokerage;
